...
""",
    ...
    "setup_app.py": """import subprocess
...
""",
    ...
    "ansible/inventory": """webserver ansible_host=<PUBLIC_IP> ansible_user=ubuntu ansible_ssh_private_key_file=/home/lilia/ec2.pem
""",
...
""",
    ...
    "ansible/roles/nginx/tasks/main.yml": """- name: Install NGINX
  apt:
    name: nginx
    state: present
...
""",
    ...
    "ansible/roles/mongodb/tasks/main.yml": """- name: Import MongoDB key
  apt_key:
...
""",
    ...
    "ansible/roles/nodeapp/tasks/main.yml": """- name: Install Node.js
  shell: |
...
# Recreate the folder structure and save the content
base_dir = "/home/lilia/VIDEOS/automated-deployment"
